...
## Using docker to train the model
* you can start the docker with the following command
```sudo docker run --runtime=nvidia -it -v /path/to/your/project/EAST:/workspace xxxxxxxxxxxxxxxxxxxx/coseast:0.1 bash ```
```
cd /workspace
source activate py27
python multigpu_train.py --gpu_list=0 --input_size=512 --batch_size_per_gpu=8 --checkpoint_path=./east_icdar2015_resnet_v1_50_rbox/ \
--text_scale=512 --training_data_path=./data/icdar15/ --geometry=RBOX --learning_rate=0.0001 --num_readers=24 \
